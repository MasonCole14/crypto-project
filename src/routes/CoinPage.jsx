            ...
            <div className="mt-3 flex">
              ...
              <div className="flex ml-2 relative top-1">
                {data.market_data?.price_change_percentage_24h > 0 ? (
                  <AiFillCaretUp className="relative top-[7px]" color="green" />
                ) : (
                  <AiFillCaretDown className="relative top-[7px]" color="red" />
                )}
                <p
                  className={
                    data.market_data?.price_change_percentage_24h > 0
          ...
          <div className="my-4 hidden sm:block">
            ...
            <div className="my-1">
              <div className="my-2">
                ...
                <div className="my-1">
                  <a
                    className="bg-gray-100 dark:bg-gray-700 rounded-xl text-center px-3 py-1 text-sm font-semibold"
